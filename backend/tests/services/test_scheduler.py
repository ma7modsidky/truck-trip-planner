...
def test_schedule_fuel_rejects_exceeding_duty_window():
    state = DriverState(
        current_time=datetime(2026, 9, 18, 21, 45),
        shift_start=datetime(2026, 9, 18, 8, 0),
    )
...
def test_schedule_pickup():
    state = DriverState(
        current_time=datetime(2026, 9, 18, 9, 0),
        shift_start=datetime(2026, 9, 18, 8, 0),
    ...
    assert event.start == datetime(2026, 9, 18, 9, 0)
    assert event.end == datetime(2026, 9, 18, 10, 0)
...
def test_schedule_dropoff():
    state = DriverState(
        current_time=datetime(2026, 9, 18, 15, 0),
        shift_start=datetime(2026, 9, 18, 8, 0),
    ...
    assert event.start == datetime(2026, 9, 18, 15, 0)
    assert event.end == datetime(2026, 9, 18, 16, 0)
